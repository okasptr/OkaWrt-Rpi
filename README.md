...
4. Pre-configured local kmod software source, away from kmod dependency conflicts
...
7. Provide full format firmware/file (ext4/squashfs/ubi/initramfs/rootfs)

12

8. For advanced users, a complete firmware/package build tool (imagebuilder/sdk/toolchain) is provided
...
Please refer to the documentation for firmware download and installation / initial setup / software package installation instructions and other information:
...
(It is recommended to save it locally to zoom in)
...
| Github Actions | OpenWrt Source Project | OpenWrt Build Project | Action Project | Cloud Service Provider |
